...
|-------|-----------------|-----------|--------------|------------|
| **Ingest** | SecretScanner blocks credential storage; API scopes gate writes | SignalGate rejects low-signal content; strongly-typed deserialization; write-time `ConflictGate` quarantines a hard-stance store contradicting a high-trust incumbent *(T-6/T-13)* | — | `MemoryProvenance` stamped on every write; pack/intake tagged at the import surface |
